...
public class FacebookBotListener extends ListenerAdapter 
{

	private static FacebookBotListener twitchBotListener;

	private FacebookBotListener() {
	}

	public static FacebookBotListener getInstance(){
		if(twitchBotListener == null){
			twitchBotListener = new FacebookBotListener();
		}

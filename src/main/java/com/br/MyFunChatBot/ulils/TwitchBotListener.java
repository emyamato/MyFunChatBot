...
public class TwitchBotListener extends ListenerAdapter 
{
	...
	private static TwitchBotListener twitchBotListener;

	private TwitchBotListener() {
	}

	public static TwitchBotListener getInstance(){
		if(twitchBotListener == null){
			twitchBotListener = new TwitchBotListener();
		}
